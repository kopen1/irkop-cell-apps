...
class Repository(private val api: ApiService) {
    ...
    suspend fun akun()=api.akun();suspend fun createAkun(body:JsonObject)=api.createAkun(body);suspend fun updateAkun(id:String,body:JsonObject)=api.updateAkun(id,body);suspend fun deleteAkun(id:String)=api.deleteAkun(id)
